...
//   () => pMinDelay(import("./component/ItemNotFound/index"), 250),
//   {
//     fallback: <Loading />,
//   }
// );
...
const RegisterSeller = loadable(() => pMinDelay(import("./page/registerSeller"), 250), {
  fallback: <Loading />,
});
      ...
      <BrowserRouter>
        <Router>
          ...
          <Switch>
            ...
            {/* <Route path="/not-found" exact component={ItemNotFound} /> */}

            <Route path="/login" exact component={Login} />
            <Route path="/register" exact component={Register} />
            <Route path="/registerasseller" exact component={RegisterSeller} />
