...
import { Tabs, Select, Input, Slider, Button, Modal } from "antd";
import { useDispatch, useSelector } from "react-redux";
import SearchIcon from "../../../assets/Group 6.png";
                          ...
                          <Tabs defaultActiveKey="1">
                            <TabPane tab="All" key="1">
                              ...
                              <div style={{ marginBottom: 20 }}>
                                <span>
                                  <b>Price Range:</b>
                                  <br /> Rs.0 - USD 3,000,000.00
                                </span>
                                <Slider range defaultValue={[20, 50]} />
                              </div>
                              <div className="login_submit d-flex justify-content-center">
                                <Link to="/item-not-found">
                                  <button className="button_loginn">
                                    Search
                                  </button>
                                </Link>
                              </div>
                            </TabPane>
                            <TabPane tab="New" key="2"></TabPane>
                            <TabPane tab="Used" key="3"></TabPane>
                          </Tabs>
                        </div>
                      </div>
                    </Modal>
              ...
              <Tabs defaultActiveKey="1">
                <TabPane tab="All" key="1">
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <Select placeholder="Model" style={{ width: 120 }}>
                      <Option value="model1">Model 1</Option>
                      <Option value="model2">Model 2</Option>
                    </Select>
                  </div>
                  ...
                  <div style={{ marginBottom: 20 }}>
                    <span>Price Range: Rs.0 - USD 3,000,000.00</span>
                    <Slider range defaultValue={[20, 50]} />
                  </div>
